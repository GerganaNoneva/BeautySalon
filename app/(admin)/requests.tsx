    ...
    <LinearGradient colors={theme.gradients.champagne} style={styles.container}>
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.header}>
          <Text style={styles.title}>Заявки за часове</Text>
        ...
        >
          <View style={styles.modalOverlay}>
            <View style={styles.actionModalContent}>
                ...
                <>
                  ...
                  <View style={{
                    ...
                    <Text style={{
                      ...
                      Клиент: {conflictingAppointment.profiles?.full_name || conflictingAppointment.unregistered_clients?.full_name || 'Неизвестен'}
                      {' \n'}
              ...
              <View style={styles.inputContainer}>
                <Text style={styles.inputLabel}>Съобщение до клиента (опционално):</Text>
                <TextInput
                  style={[styles.timeTextInput, { height: 80, textAlignVertical: 'top' }]}
